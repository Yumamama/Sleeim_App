...
//https://github.com/naichilab/Unity-TouchManager/blob/master/LICENSE
...
namespace naichilab.InputEvents
{
	...
	public class TouchManager :MonoBehaviour
	{
		...
		public event EventHandler<CustomInputEventArgs> NavigationAction;
		...
		private CustomInput InputOfTouch {
			get {
				...
				if (Input.GetKeyDown (KeyCode.Escape)) {
					input.IsNavigationBackDown = true;
				}
		...
		private void Start ()
		{
			...
			this.Detectors.Add (this.GetComponent<NavigationDetector> ());
		}
		...
		public void OnGUI ()
		{
			...
			GUI.Label (new Rect (20, 20 + i++ * 20, 400, 20), string.Format ("NavigationBack : {0}", input.IsNavigationBackDown));
		}
	}
}
